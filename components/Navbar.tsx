      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          >
            ...
            <span className="font-black text-2xl tracking-tighter text-slate-900">ArciKeys<span className="text-red-500">.</span></span>
          </div>
          ...
          <div className="hidden md:flex space-x-1 items-center bg-white/50 backdrop-blur-sm px-2 py-1 rounded-full border border-slate-100/50">
            ...
            <button className="px-5 py-2 rounded-full text-sm font-bold text-slate-500 hover:bg-slate-100 hover:text-slate-900 transition-all">
              About
            </button>
          </div>
