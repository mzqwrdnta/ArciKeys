      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative h-[400px] sm:h-[600px] flex items-center justify-center z-10 perspective-1000">
             ...
             <div className="absolute top-20 right-0 sm:right-10 bg-white/90 backdrop-blur-md p-4 rounded-2xl shadow-xl border border-white z-20 animate-bounce-slow">
               <div className="flex items-center gap-3">
                 ...
                 <div>
                   ...
                   <p className="text-lg font-black text-slate-900">Rp 45.000</p>
                 </div>
               </div>
             </div>
